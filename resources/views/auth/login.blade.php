...
<head>
    ...
    <title>Login - Sistem Inventaris Apotek</title>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="login-card p-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h3 class="fw-bold text-dark">Sistem Apotek</h3>
                        ...
                        <div class="text-center">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    <div class="card border-0 bg-light">
                                        <div class="card-body p-2">
                                            ...
                                            <small>admin@apotek.com</small><br>
                                ...
                                <div class="col-6">
                                    <div class="card border-0 bg-light">
                                        <div class="card-body p-2">
                                            <small class="text-success fw-bold">Staff</small><br>
                                            <small>staff@apotek.com</small><br>
